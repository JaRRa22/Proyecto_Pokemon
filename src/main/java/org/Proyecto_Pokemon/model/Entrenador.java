...
public static void tiposCria(Pokemon padre, Pokemon madre){
    ...
    if(CriarController.pokemonCriado.getTipos().size() > 1) {
        Tipo prueba1 = CriarController.pokemonCriado.getTipos().get(0);
        Tipo prueba2 = CriarController.pokemonCriado.getTipos().get(1);
        if (prueba1.equals(prueba2)) {
            CriarController.pokemonCriado.getTipos().remove(1);
        }
    }
}

public static void sexoCria(Pokemon padre, Pokemon madre) {
    Random rd = new Random();
